...
import com.skyrstudios.vibraniumtechnologies.item.ModArmorMaterials;
...
public class VibraniumArmorItem extends ArmorItem {
    ...
    public VibraniumArmorItem(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
